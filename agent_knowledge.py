...
Backend module to process knowledge files for Concierge AI Agents.
...
def process_agent_knowledge(agent_name: str) -> str:
    ...
    logger.info(f"[{agent_name}] Calling '{config.agent_config.SUBAGENT_PRO_MODEL}' for markdown extraction...")
